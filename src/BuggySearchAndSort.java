...
public class BuggySearchAndSort {
	...
	public static boolean contains(int[] array, int val) {
		for (int i = 0; i < array.length; i++) {
			...
			//else /*should not be else statment*/
				//return false;
		//}
		return false;
	}
	...
	public static void bubbleSort(int[] array) {
		for (int i = 0; i < array.length; i++) {
			for (int j = 0; j < array.length - 1; j++) { /*should be j++*/
	...
	public static void selectionSort(int[] array) {
		for (int top = array.length - 1; top > 0; top--) {
			int positionOfMax = 0;
			for (int i = 1; i <= top; i++) {
				if (array[i] > array[positionOfMax]) // array[i] instead of [1]
					positionOfMax = i;
			}
	...
	public static void insertionSort(int[] array) {
		for (int top = 1; top < array.length; top++) {
			...
			array[pos+1] = temp; // place temp into last vacated position // should be array[pos+1]
		}
	}
